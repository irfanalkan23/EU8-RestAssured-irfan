...
public class SpartanHamcrestTest extends SpartanTestBase {
    ...
    public void test1(){
        ...
        List<String> names = given().accept(ContentType.JSON)
                ...
                .statusCode(200)
                .and()
                .body("totalElement", is(3))    //we get the totalElement result from Postman
                .extract().response().jsonPath().getList("content.name");// Gpath syntax: "content.name".
    ...
    public void test2(){
        ...
        int statusCode = given().accept(ContentType.JSON)
                        ...
                        .then()
                                ...
                                .and()
                                .body("totalElement", is(3))    //we get the totalElement result from Postman
                                .extract().response().statusCode();// Gpath syntax: "content.name".
             // .extract().statusCode();        // --> also works
