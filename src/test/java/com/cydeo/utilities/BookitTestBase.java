...
public class BookitTestBase {
    ...
    public static void tearDown(){
        reset();    //resetting the baseURI. when you need different baseURIs
    }
    ...
    public static ResponseSpecification userCheck(String firstName,String lastName){
        return expect()
                ...
                //this could be a long Gpath syntax like firstName[0].role.id....
                .body("lastName",is(lastName))
                .logDetail(LogDetail.ALL);
    }

    //advanced lazy way :)
    //roles: teacher, student-member, student-leader
