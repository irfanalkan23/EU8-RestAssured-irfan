...
public class SpartanPojoGetRequestTest extends SpartanTestBase {
    ...
    public void oneSpartanPojo(){
        ...
        //path is empty here, because we got one Spartan object already, and we can directly convert to Spartan class
        //this way is more powerful, because first way you can not specify the path
